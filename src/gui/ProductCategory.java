 ...
 * @author Shakith
 */
public class ProductCategory extends javax.swing.JDialog {
     ...
     */
    public ProductCategory(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public ProductCategory(java.awt.Frame parent, boolean modal, ProductRegistration registration) {
        super(parent, modal);
        initComponents();
...
//                    JOptionPane.showMessageDialog(this, "Category Added Successfuly", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProductCategory dialog = new ProductCategory(new javax.swing.JFrame(), true);
